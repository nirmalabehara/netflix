let movieDetails = {
    "Animal": {
      ...
      "trailer": "https://www.youtube.com/watch?v=YD7b4gU0HWQ",
      "releaseDate": "2024",
      "rating": "8.5/10",
  ...
  "Ghost Stories": {
    "title": "Ghost Stories",
    "genre": "Horror, Thriller",
    "director": "Anurag Kashyap, Karan Johar, Dibakar Banerjee, Zoya Akhtar",
    "releaseDate": "2020",
    "rating": "6.2/10",
...
"True Beauty": {
  ...
  function showMovieDetails(movie) {
    let movieInfo = movieDetails[movie];
  ...
  <img src="${movieInfo.image}" alt="${movieInfo.title}" style="width: 100%; max-width: 400px; height: auto;">
  ...
  <p><strong>Trailer:</strong> <a href="${movieInfo.trailer}" target="_blank" style="color: blue; text-decoration: underline;">Watch Trailer</a></p>
`;
